...
% Reah raw hi-c data files an extract 1d profiles around a given region
...
for ii = 1:length(arg.cell_lines)
    ii
    %% Read data
    hic_data = importdata(sprintf('~/Documents/genome_arch/data/hic/%s/%dkb_resolution_intrachromosomal/chr%d/MAPQG0/chr%d_%dkb.RAWobserved',arg.cell_lines{ii},arg.resolution,arg.chromosome,arg.chromosome,arg.resolution),'\t');
    hic_norm_vector = importdata(sprintf('~/Documents/genome_arch/data/hic/%s/%dkb_resolution_intrachromosomal/chr%d/MAPQG0/chr%d_%dkb.KRnorm',arg.cell_lines{ii},arg.resolution,arg.chromosome,arg.chromosome,arg.resolution),'\t');
